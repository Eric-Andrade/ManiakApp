...
import {Dimensions, View, useColorScheme, Platform} from 'react-native';
  ...
  ({
    ...
    return (
      <Modal
        ...
        // swipeDirection='down'
        backdropColor={
          colorSchema === 'dark' ? 'rgba(0, 0, 0, 0.55)' : 'rgba(0, 0, 0, 0.3)'
        }
        backdropOpacity={0.7}
        ...
        <Container>
          <CardContainer>
            ...
            <Header>
              ...
              <HeaderRight onPress={closeModal}>
                <Ionicons
                  name="md-close"
                  size={18}
                  color={themeContext.SECONDARY_TEXT_BACKGROUND_COLOR}
